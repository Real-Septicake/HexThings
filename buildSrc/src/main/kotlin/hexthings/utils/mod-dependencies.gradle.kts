...
abstract class HexthingsModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexthingsModDependenciesExtension>("hexthingsModDependencies")
