...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexthings.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexthings-common-common-refmap.json
        // fixed:   hexthings-common.refmap.json
