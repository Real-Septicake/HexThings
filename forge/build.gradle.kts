...
loom {
    forge {
        ...
        mixinConfig(
            "hexthings-common.mixins.json",
            "hexthings-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexthings.apply-datagen-mixin", "true")
                property("hexthings.$platform-datagen", "true")
            }
        }
    }
}

hexthingsModDependencies {
